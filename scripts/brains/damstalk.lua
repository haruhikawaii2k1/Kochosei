-- require "behaviours/follow" cutttttttttttttt
...
local damstalk = Class(Brain, function(self, inst)
...
local SPIKE_TARGET_CANT_TAGS = { "fossil", "playerghost", "shadow", "INLIMBO", "player" }
